...
export const CLOSET_ITEMS = [
  ...
  mk("오버핏 블랙 반팔",    "MUSINSA STD",     "상의", "반팔 티셔츠", IMG.tanTank,     "블랙",   "L",  ["봄","여름"], ["오버핏","스트릿"]),
  mk("스트라이프 반팔",     "GAP",             "상의", "반팔 티셔츠", IMG.stripedTee,  "네이비", "S",  ["봄","여름"], ["스트라이프","캐주얼"]),
  mk("그래픽 프린트 반팔",  "STUSSY",          "상의", "반팔 티셔츠", IMG.rustTop,     "그레이", "M",  ["여름"],     ["그래픽","스트릿"]),
  mk("리넨 혼방 반팔",      "COS",             "상의", "반팔 티셔츠", IMG.beigeTop,    "베이지", "M",  ["여름"],     ["린넨","미니멀"]),

  // 긴팔 티셔츠
  mk("머슬핏 긴팔",         "MUSINSA STD",     "상의", "긴팔 티셔츠", IMG.blackKnit,   "화이트", "M",  ["봄","가을"], ["피티드","베이직"]),
  mk("오버핏 헤비 긴팔",    "REPRESENT",       "상의", "긴팔 티셔츠", IMG.knitGray,    "블랙",   "L",  ["봄","가을"], ["오버핏","헤비웨이트"]),
  mk("스트라이프 긴팔",     "UNIQLO",          "상의", "긴팔 티셔츠", IMG.stripedTee,  "네이비", "S",  ["봄","가을"], ["스트라이프","캐주얼"]),
  mk("코튼 슬림 긴팔",      "ZARA",            "상의", "긴팔 티셔츠", IMG.whiteAsym,   "그레이", "M",  ["봄","가을"], ["슬림핏","데일리"]),
  mk("터틀넥 긴팔",         "COS",             "상의", "긴팔 티셔츠", IMG.blackKnit,   "크림",   "S",  ["가을","겨울"],["터틀넥","미니멀"]),

  // 셔츠
  mk("화이트 오버핏 셔츠",  "MUSINSA STD",     "상의", "셔츠",       IMG.blouse2,     "화이트", "M",  ["봄","가을"], ["오버핏","데일리"]),
  mk("체크 패턴 셔츠",      "POLO RL",         "상의", "셔츠",       IMG.beigeTop,    "블루",   "M",  ["봄","가을"], ["체크","캐주얼"]),
  mk("린넨 셔츠",           "H&M",             "상의", "셔츠",       IMG.beigeTop,    "베이지", "M",  ["봄","여름"], ["린넨","캐주얼"]),
  mk("옥스포드 셔츠",       "BROOKS BROS",     "상의", "셔츠",       IMG.blouse2,     "화이트", "M",  ["봄","가을"], ["클래식","오피스"]),

  // 블라우스
  mk("실크 브이넥 블라우스", "SANDRO",         "상의", "블라우스",    IMG.blouse,      "아이보리","S", ["봄","여름"], ["실크","페미닌"]),
  mk("플로럴 블라우스",     "& OTHER STORIES", "상의", "블라우스",    IMG.whiteAsym,   "플로럴", "S",  ["봄","여름"], ["플로럴","페미닌"]),
  mk("러플 블라우스",       "MAJE",            "상의", "블라우스",    IMG.blouse,      "크림",   "XS", ["봄"],       ["러플","로맨틱"]),
  mk("시스루 블라우스",     "ZARA",            "상의", "블라우스",    IMG.blouse2,     "화이트", "S",  ["봄","여름"], ["시스루","트렌디"]),

  // 니트/스웨터
  mk("메리노울 크루넥",     "UNIQLO",          "상의", "니트/스웨터", IMG.knitTop,     "오트밀", "M",  ["가을","겨울"],["울","베이직"]),
  mk("케이블 니트",         "ARKET",           "상의", "니트/스웨터", IMG.knitCream,   "아이보리","S", ["가을","겨울"],["케이블","볼륨"]),
  mk("알파카 오버핏 니트",  "& OTHER STORIES", "상의", "니트/스웨터", IMG.knitFuzzy,   "베이지", "M",  ["가을","겨울"],["알파카","오버핏"]),
  mk("컬러블록 니트",       "ALAND",           "상의", "니트/스웨터", IMG.knitOlive,   "멀티",   "M",  ["가을","겨울"],["컬러블록","트렌디"]),
  mk("리브드 슬림 니트",    "COS",             "상의", "니트/스웨터", IMG.knitGray,    "그레이", "S",  ["가을","겨울"],["리브드","슬림"]),

  // 후드티
  mk("오버핏 기모 후드",    "MUSINSA STD",     "상의", "후드티",      IMG.knitGray,    "블랙",   "L",  ["가을","겨울"],["오버핏","기모"]),
  mk("심플 후드 집업",      "CHAMPION",        "상의", "후드티",      IMG.knitCream2,  "그레이", "M",  ["봄","가을"], ["집업","스포티"]),
  mk("크롭 후드티",         "ADIDAS",          "상의", "후드티",      IMG.knitOlive,   "화이트", "S",  ["봄","가을"], ["크롭","스포티"]),

  // 맨투맨
  mk("베이직 맨투맨",       "CHAMPION",        "상의", "맨투맨",      IMG.knitCream2,  "그레이", "M",  ["봄","가을","겨울"],["베이직","캐주얼"]),
  mk("아치 로고 맨투맨",    "TOMMY",           "상의", "맨투맨",      IMG.knitGray,    "네이비", "M",  ["봄","가을"], ["로고","캐주얼"]),
  mk("오버핏 크루넥 스웻",  "STUSSY",          "상의", "맨투맨",      IMG.blackKnit,   "블랙",   "L",  ["봄","가을"], ["오버핏","스트릿"]),

  // 탱크탑
  mk("립 슬리브리스",       "SKIMS",           "상의", "탱크탑",      IMG.rustTop,     "베이지", "S",  ["여름"],     ["립","보디핏"]),
  mk("코튼 나시",           "UNIQLO",          "상의", "탱크탑",      IMG.whiteTee,    "화이트", "M",  ["봄","여름"], ["베이직","레이어드"]),
  mk("스퀘어넥 탑",         "ZARA",            "상의", "탱크탑",      IMG.tanTank,     "블랙",   "S",  ["봄","여름"], ["스퀘어넥","페미닌"]),

  // 가디건
  mk("오버핏 롱 가디건",    "ARKET",           "상의", "가디건",      IMG.cardBrown,   "베이지", "M",  ["봄","가을"], ["롱","레이어드"]),
  mk("크롭 버튼 가디건",    "& OTHER STORIES", "상의", "가디건",      IMG.cardGray,    "크림",   "S",  ["봄","가을"], ["크롭","페미닌"]),
  mk("집업 가디건",         "UNIQLO",          "상의", "가디건",      IMG.cardGray,    "그레이", "M",  ["봄","가을","겨울"],["집업","캐주얼"]),

  // 크롭탑
  mk("코튼 크롭 탑",        "ZARA",            "상의", "크롭탑",      IMG.whiteTee,    "화이트", "S",  ["봄","여름"], ["크롭","캐주얼"]),
  mk("넥타이 크롭",         "MAJE",            "상의", "크롭탑",      IMG.rustTop,     "블랙",   "XS", ["봄","여름"], ["타이 프론트","트렌디"]),
  ...
  mk("슬림 스키니 데님",    "ZARA",            "하의", "청바지",      IMG.denim2,      "다크인디고","S", ["가을","겨울"],    ["슬림","베이직"]),
  mk("스트레치 하이라이즈", "COS",             "하의", "청바지",      IMG.denim2,      "블랙",   "S",  ["봄","가을"],      ["하이라이즈","핏"]),
  mk("배럴핏 데님",         "LEVIS",           "하의", "청바지",      IMG.denim,       "라이트블루","M", ["봄","가을"],     ["배럴핏","트렌디"]),

  // 슬랙스
  mk("와이드 슬랙스",       "COS",             "하의", "슬랙스",      IMG.widePants,   "베이지", "M",  ["봄","가을"],      ["와이드","오피스"]),
  mk("테이퍼드 슬랙스",     "ZARA",            "하의", "슬랙스",      IMG.trousers,    "블랙",   "S",  ["봄","가을","겨울"],["테이퍼드","오피스"]),
  mk("스트라이프 슬랙스",   "SANDRO",          "하의", "슬랙스",      IMG.trousers,    "네이비", "M",  ["봄","가을"],      ["스트라이프","세미포멀"]),
  mk("플리츠 슬랙스",       "ARKET",           "하의", "슬랙스",      IMG.widePants,   "오트밀", "M",  ["봄","가을"],      ["플리츠","미니멀"]),
  mk("울 혼방 슬랙스",      "COS",             "하의", "슬랙스",      IMG.trousers,    "그레이", "M",  ["가을","겨울"],    ["울","클래식"]),

  // 반바지
  mk("데님 반바지",         "LEVIS",           "하의", "반바지",      IMG.denim2,      "라이트블루","S", ["여름"],          ["데님","캐주얼"]),
  mk("린넨 반바지",         "H&M",             "하의", "반바지",      IMG.widePants,   "베이지", "M",  ["여름"],          ["린넨","캐주얼"]),
  mk("스포티 반바지",       "ADIDAS",          "하의", "반바지",      IMG.trousers,    "블랙",   "M",  ["봄","여름"],     ["스포티","액티브"]),

  // 미니스커트
  mk("플리츠 미니스커트",   "ARKET",           "하의", "미니스커트",  IMG.skirtCheck,  "블랙",   "S",  ["봄","여름"],     ["플리츠","미니멀"]),
  mk("플로럴 미니",         "MAJE",            "하의", "미니스커트",  IMG.skirtMini,   "플로럴", "XS", ["봄","여름"],     ["플로럴","페미닌"]),
  mk("체크 미니스커트",     "& OTHER STORIES", "하의", "미니스커트",  IMG.skirtCheck,  "체크",   "S",  ["봄","가을"],     ["체크","트렌디"]),
  mk("레더 미니스커트",     "ZARA",            "하의", "미니스커트",  IMG.skirtMini,   "블랙",   "S",  ["가을","겨울"],   ["레더","엣지"]),

  // 미디스커트
  mk("사틴 미디스커트",     "SANDRO",          "하의", "미디스커트",  IMG.skirt,       "블러쉬", "S",  ["봄","여름"],     ["사틴","페미닌"]),
  mk("플리츠 미디",         "COS",             "하의", "미디스커트",  IMG.skirtPlaid,  "오트밀", "M",  ["봄","여름","가을"],["플리츠","미니멀"]),
  mk("니트 미디스커트",     "ARKET",           "하의", "미디스커트",  IMG.skirt,       "카멜",   "S",  ["가을","겨울"],   ["니트","레이어드"]),

  // 와이드팬츠
  mk("와이드 리넨 팬츠",    "COS",             "하의", "와이드팬츠",  IMG.widePants,   "베이지", "M",  ["봄","여름"],     ["린넨","와이드"]),
  mk("와이드 울 팬츠",      "ARKET",           "하의", "와이드팬츠",  IMG.trousers,    "그레이", "M",  ["가을","겨울"],   ["울","볼륨"]),
  mk("와이드 코튼 팬츠",    "MUSINSA STD",     "하의", "와이드팬츠",  IMG.widePants,   "블랙",   "L",  ["봄","가을"],     ["코튼","캐주얼"]),
  mk("팔라조 팬츠",         "ZARA",            "하의", "와이드팬츠",  IMG.trousers,    "화이트", "S",  ["봄","여름"],     ["팔라조","페미닌"]),
  ...
  // 레깅스
  mk("코튼 스키니 레깅스",  "UNIQLO",          "하의", "레깅스",      IMG.denim2,      "블랙",   "S",  ["봄","가을","겨울"],["스키니","레이어드"]),
  mk("와이드 레깅스",       "ZARA",            "하의", "레깅스",      IMG.denim,       "네이비", "S",  ["가을","겨울"],   ["와이드","캐주얼"]),

  // 조거팬츠
  mk("테리 조거팬츠",       "A.P.C",           "하의", "조거팬츠",    IMG.widePants,   "오트밀", "M",  ["봄","가을"],     ["테리","스포티-럭셔리"]),
  mk("테이퍼드 조거",       "STUSSY",          "하의", "조거팬츠",    IMG.trousers,    "블랙",   "L",  ["봄","가을"],     ["테이퍼드","스트릿"]),

  // 맥시스커트
  mk("사틴 맥시스커트",     "TOTEME",          "하의", "맥시스커트",  IMG.skirt,       "블랙",   "S",  ["봄","여름","가을"],["사틴","우아한"]),
  mk("플로럴 맥시",         "MAJE",            "하의", "맥시스커트",  IMG.skirtPlaid,  "플로럴", "S",  ["봄","여름"],     ["플로럴","로맨틱"]),

  // ──────────────────────────────── 아우터 ────────────────────────────────────
  // 트렌치코트
  mk("클래식 트렌치",       "BURBERRY",        "아우터", "트렌치코트",  IMG.trench,    "카멜",   "M",  ["봄","가을"],     ["클래식","타임리스"], 380000),
  mk("오버핏 트렌치",       "TOTEME",          "아우터", "트렌치코트",  IMG.trench2,   "베이지", "M",  ["봄","가을"],     ["오버핏","트렌디"],   198000),
  mk("미디 트렌치코트",     "COS",             "아우터", "트렌치코트",  IMG.trench,    "그레이", "S",  ["봄","가을"],     ["미디","미니멀"],     89000),
  mk("롱 트렌치코트",       "ZARA",            "아우터", "트렌치코트",  IMG.trench2,   "카멜",   "M",  ["봄","가을"],     ["롱","클래식"],       69000),

  // 울 코트
  mk("싱글 울 코트",        "ARKET",           "아우터", "울 코트",     IMG.coatIvory, "카멜",   "M",  ["가을","겨울"],   ["울","클래식"],       245000),
  mk("더블 브레스트 코트",  "SANDRO",          "아우터", "울 코트",     IMG.coatChoco, "블랙",   "S",  ["가을","겨울"],   ["더블브레스트","세미포멀"], 320000),
  mk("오버핏 울 코트",      "COS",             "아우터", "울 코트",     IMG.coatIvory, "오트밀", "M",  ["가을","겨울"],   ["오버핏","미니멀"],   195000),
  mk("체크 울 코트",        "MAX MARA",        "아우터", "울 코트",     IMG.coatChoco, "체크",   "S",  ["가을","겨울"],   ["체크","클래식"],     420000),

  // 패딩
  mk("숏 패딩",             "MONCLER",         "아우터", "패딩",        IMG.streetJkt, "블랙",   "M",  ["겨울"],          ["숏","럭셔리"],       850000),
  mk("롱 패딩",             "NORTHFACE",       "아우터", "패딩",        IMG.coatChoco, "블랙",   "M",  ["겨울"],          ["롱","기능성"],       320000),
  mk("슬림 다운 패딩",      "UNIQLO",          "아우터", "패딩",        IMG.streetJkt, "네이비", "M",  ["가을","겨울"],   ["슬림","베이직"],     89000),
  mk("오버핏 패딩",         "HUFLAND",         "아우터", "패딩",        IMG.coatChoco, "블루",   "L",  ["겨울"],          ["오버핏","스트릿"],   145000),

  // 블레이저
  mk("테일러드 블레이저",   "COS",             "아우터", "블레이저",    IMG.blazer,    "블랙",   "S",  ["봄","가을"],     ["테일러드","오피스"],  98000),
  mk("오버핏 블레이저",     "ZARA",            "아우터", "블레이저",    IMG.blazerBurg,"베이지", "M",  ["봄","가을"],     ["오버핏","캐주얼"],    79000),
  mk("더블 블레이저",       "MAJE",            "아우터", "블레이저",    IMG.blazerNavy,"네이비", "S",  ["봄","가을"],     ["더블","세미포멀"],   145000),
  ...
  mk("보머 재킷",           "ALAND",           "아우터", "점퍼",        IMG.coatBeige, "올리브",  "M", ["봄","가을"],     ["보머","캐주얼"],       65000),

  // 레더재킷
  mk("라이더스 레더",       "ALLSAINTS",       "아우터", "레더재킷",    IMG.blazer,    "블랙",   "M",  ["가을","겨울"],   ["라이더스","엣지"],   320000),
  mk("크롭 레더재킷",       "ZARA",            "아우터", "레더재킷",    IMG.blazerBurg,"블랙",   "S",  ["봄","가을"],     ["크롭","트렌디"],       89000),

  // 다운재킷
  mk("경량 다운 조끼",      "UNIQLO",          "아우터", "다운재킷",    IMG.coatBeige, "블랙",   "M",  ["가을","겨울"],   ["다운","경량"],        69000),
  mk("롱 다운 파카",        "CANADA GOOSE",    "아우터", "다운재킷",    IMG.coatChoco, "카키",   "M",  ["겨울"],          ["파카","기능성"],     980000),

  // 오버핏코트
  mk("오버핏 맥코트",       "TOTEME",          "아우터", "오버핏코트",  IMG.coatChoco, "블랙",   "M",  ["가을","겨울"],   ["오버핏","시크"],     298000),
  mk("더블 오버핏코트",     "COS",             "아우터", "오버핏코트",  IMG.coatIvory, "카멜",   "M",  ["가을","겨울"],   ["더블","볼륨"],       178000),

  // ──────────────────────────────── 원피스 ────────────────────────────────────
  // 미니 원피스
  mk("플로럴 미니 원피스",  "MAJE",            "원피스","미니 원피스",  IMG.dotDress,  "플로럴", "XS", ["봄","여름"],     ["플로럴","페미닌"],    89000),
  ...
  mk("사틴 미디 드레스",    "SANDRO",          "원피스","미디 원피스",  IMG.slvlessDress,"블랙", "S",  ["봄","여름","가을"],["사틴","시크"],       115000),
  mk("니트 미디 드레스",    "COS",             "원피스","미디 원피스",  IMG.florDress, "베이지", "M",  ["가을","겨울"],   ["니트","미니멀"],       88000),
  mk("슬립 미디 드레스",    "ARKET",           "원피스","미디 원피스",  IMG.slvlessDress,"크림", "S",  ["봄","여름"],     ["슬립","미니멀"],       79000),

  // 맥시 원피스
  mk("플로럴 맥시 드레스",  "& OTHER STORIES", "원피스","맥시 원피스",  IMG.maxiDress, "플로럴", "S",  ["봄","여름"],     ["플로럴","로맨틱"],    98000),
  mk("사틴 맥시 드레스",    "TOTEME",          "원피스","맥시 원피스",  IMG.maxiDress, "블랙",   "S",  ["봄","여름","가을"],["사틴","드라마틱"],  245000),

  // 점프수트
  mk("린넨 점프수트",       "COS",             "원피스","점프수트",     IMG.slvlessDress,"베이지","M", ["봄","여름"],     ["린넨","캐주얼"],       75000),
  mk("슬림 점프수트",       "ZARA",            "원피스","점프수트",     IMG.dotDress,  "블랙",   "S",  ["봄","가을"],     ["슬림","오피스"],       65000),

  // 니트 원피스
  mk("리브드 니트 드레스",  "ARKET",           "원피스","니트 원피스",  IMG.knitTop,   "크림",   "S",  ["가을","겨울"],   ["리브드","미니멀"],     89000),
  mk("케이블 니트 드레스",  "& OTHER STORIES", "원피스","니트 원피스",  IMG.knitCream, "베이지", "M",  ["가을","겨울"],   ["케이블","볼륨"],        75000),

  // ──────────────────────────────── 신발 ─────────────────────────────────────
  mk("골든구스 스니커즈",   "GOLDEN GOOSE",    "신발",  "스니커즈",    IMG.lifestyle1, "화이트","250", ["봄","가을"],     ["클래식","스트릿"],    299000),
  mk("올스타 블랙",         "CONVERSE",        "신발",  "스니커즈",    IMG.lifestyle1, "블랙",  "240", ["봄","가을"],     ["클래식","캐주얼"],     79000),
  mk("아디다스 삼바",       "ADIDAS",          "신발",  "스니커즈",    IMG.lifestyle1, "화이트","245", ["봄","가을"],     ["레트로","트렌디"],     99000),
  mk("옥스포드 슈즈",       "NEW BALANCE",     "신발",  "옥스퍼드",    IMG.lifestyle2, "실버",  "250", ["봄","가을"],     ["청키","캐주얼"],        89000),
  mk("블랙 로퍼",           "GUCCI",           "신발",  "로퍼",        IMG.lifestyle2, "블랙",  "245", ["봄","가을"],     ["클래식","오피스"],    320000),
  mk("소호 로퍼",           "COS",             "신발",  "로퍼",        IMG.lifestyle2, "카멜",  "240", ["봄","가을"],     ["미니멀","오피스"],     89000),
  mk("발레 플랫",           "ZARA",            "신발",  "힐/펌프스",   IMG.flats,      "블랙",  "245", ["봄","가을"],     ["클래식","포멀"],        65000),
  mk("브라운 롱부츠",       "TOTEME",          "신발",  "앵클 부츠",   IMG.boots,      "브라운","245", ["가을","겨울"],   ["미니멀","클래식"],    145000),
  mk("사첼 샌들",           "MANGO",           "신발",  "샌들",        IMG.flats,      "누드",  "240", ["봄","여름"],     ["청키","캐주얼"],        59000),

  // ──────────────────────────────── 가방 ─────────────────────────────────────
  mk("버건디 숄더백",       "POLENE",          "가방",  "숄더백",      IMG.bagBurg,    "버건디","FREE",["봄","가을"],     ["레더","미니멀"],      245000),
  mk("미니 크로스백",        "CHARLES&KEITH",   "가방", "크로스백",    IMG.bagSaddle,  "블랙",  "FREE",["봄","가을","겨울"],["미니","데일리"],       59000),
  mk("버건디 토트백",        "A.P.C",           "가방", "토트백",      IMG.bagTote,    "버건디","FREE",["봄","여름"],     ["캔버스","캐주얼"],    145000),
  mk("미니 핸드백",          "MANGO",           "가방", "클러치",      IMG.bagMini,    "골드",  "FREE",["봄","여름"],     ["이브닝","파티"],        49000),
  mk("노트백",               "COS",             "가방", "백팩",        IMG.bagKnot,    "크림",  "FREE",["봄","가을","겨울"],["가죽","미니멀"],      125000),

  // ──────────────────────────────── 액세서리 ──────────────────────────────────
  mk("골드 레이어드 목걸이",  "MANGO",          "액세서리","목걸이",    IMG.necklace,   "골드",  "FREE",["봄","여름"],     ["레이어드","심플"],     29000),
  mk("진주 귀걸이",           "ZARA",           "액세서리","귀걸이",    IMG.pearlearrings,"화이트","FREE",["봄","여름"], ["진주","클래식"],        25000),
  mk("빅 선글라스",           "GENTLE MONSTER", "액세서리","선글라스",  IMG.glasses,    "블랙",  "FREE",["봄","여름"],     ["오버사이즈","시크"],  198000),
  mk("씬 레더 벨트",          "COS",            "액세서리","벨트",      IMG.belt,       "블랙",  "FREE",["봄","가을","겨울"],["와이드","미니멀"],     39000),
  mk("플래드 스카프",         "KANGOL",         "액세서리","스카프",    IMG.plaidScarf, "체크",  "FREE",["봄","여름"],     ["버킷","캐주얼"],        55000),
  mk("실크 스카프",           "HERMÈS",         "액세서리","스카프",    IMG.silkScarf,  "멀티",  "FREE",["봄","여름"],     ["실크","페미닌"],       189000),
  mk("골드 시계",             "CARTIER",        "액세서리","시계",      IMG.goldWatch,  "골드",  "FREE",["봄","가을","겨울"],["클래식","럭셔리"],   1200000),
  mk("훕 이어링",             "MANGO",          "액세서리","귀걸이",    IMG.accessories1,"골드", "FREE",["봄","여름"],     ["후프","캐주얼"],        39000),

  // ──────────────────────────────── 스포츠 ────────────────────────────────────
  mk("하이웨이스트 레깅스",   "LULULEMON",      "스포츠","스포츠 레깅스",IMG.denim2,    "블랙",  "S",  ["봄","가을"],     ["하이웨이스트","기능성"],89000),
  ...
  mk("골든구스 러닝화",       "GOLDEN GOOSE",   "스포츠","러닝화",      IMG.lifestyle1, "화이트","250",["봄","가을"],     ["쿠션","기능성"],       299000),
  mk("요가 조거팬츠",         "LULULEMON",      "스포츠","요가복",      IMG.widePants,  "그레이","S",  ["봄","가을"],     ["요가","편안함"],        89000),
  mk("윈드브레이커",          "NORTHFACE",      "스포츠","윈드브레이커", IMG.trench2,   "올리브","M",  ["봄","가을"],     ["방풍","기능성"],       145000),
];
