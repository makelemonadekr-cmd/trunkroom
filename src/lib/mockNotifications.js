...
export const OTHER_CLOSET_NOTIFICATIONS = [
  ...
  },
  {
    ...
    sourceGroup: "other_closet",
    badge: "스타일 추천",
    title: "좋아할 만한 미니멀 코디가 올라왔어요",
    body: "내 취향에 맞는 새 코디를 발견했어요",
    timeAgo: "2일 전",
    isRead: true,
    relatedItemIds: [],
    relatedClosetId: null,
  ...
  },
  {
    ...
    sourceGroup: "other_closet",
    badge: "팔로우",
    title: "팔로우한 옷장이 코디북을 업데이트했어요",
    body: "새로운 코디 3개가 추가됐어요",
    timeAgo: "3일 전",
    isRead: true,
    relatedItemIds: [],
    relatedClosetId: "closet-01",
